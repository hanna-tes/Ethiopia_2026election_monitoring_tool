...
CONFIG = {
    ...
    "lexicon": {
        # === Ethnic/Identity-Based Terms & Slurs ===
        "ethnic_identity": {
            ...
            "ነፍጠ": {"severity": "high", "target_entity": "Amhara", "language": "amharic"},
            "ነፍጠ አመለካከት": {"severity": "high", "target_entity": "Amhara", "language": "amharic"},
            "ነፍጠኛ ፋኖ": {"severity": "high", "target_entity": "Amhara", "language": "amharic"},
            "አሳሪ ነፍኛ": {"severity": "high", "target_entity": "Amhara", "language": "amharic"},
            "neftegna": {"severity": "high", "target_entity": "Amhara", "language": "english"},
            "ሮሞ": {"severity": "medium", "target_entity": "Oromo", "language": "amharic"},
            "oromo": {"severity": "medium", "target_entity": "Oromo", "language": "english"},
            "ጋላ": {"severity": "high", "target_entity": "Oromo", "language": "amharic"},
            "ጋላ ህ": {"severity": "high", "target_entity": "Oromo", "language": "amharic"},
            "አንተ ጋላ": {"severity": "high", "target_entity": "Oromo", "language": "amharic"},
            "ጥምብ ላ": {"severity": "high", "target_entity": "Oromo", "language": "amharic"},
            ...
            "አሜ ውያኔ ትግሬ ነው": {"severity": "high", "target_entity": "Tigrayan", "language": "amharic"},
            ...
            "አር": {"severity": "medium", "target_entity": "Afar", "language": "amharic"},
            ...
            "ልቋል በሊታ": {"severity": "high", "target_entity": "Tigrayan", "language": "amharic"},
            "ቆምጨ": {"severity": "high", "target_entity": "Amhara", "language": "amharic"},
            "አይ ምጨ ፋራዉ": {"severity": "high", "target_entity": "Amhara", "language": "amharic"},
            ...
            "አማራ ጠል": {"severity": "high", "target_entity": "", "language": "amharic"},
            "አማራ ስጋ": {"severity": "high", "target_entity": "", "language": "amharic"},
            "Fota-wearer": {"severity": "medium", "target_entity": "Amhara", "language": "english"},
            "ፎጣ ለሽ": {"severity": "medium", "target_entity": "Amhara", "language": "amharic"},
            "የቀን ብ": {"severity": "high", "target_entity": "Tigrayan", "language": "amharic"},
            "የቀን ብ ዘራፊዎች": {"severity": "high", "target_entity": "Tigrayan", "language": "amharic"},
            "ተረኛ": {"severity": "high", "target_entity": "Oromo", "language": "amharic"},
            "Jawsa": {"severity": "high", "target_entity": "Amhara", "language": "oromo"}
        },
        
        # === Political Groups, Factions & Systems ===
        "political_groups": {
            "ብልግና": {"severity": "low", "target_entity": "Prosperity Party", "language": "amharic"},
            "ብልፅና ታጥቦ ከቃ ነው": {"severity": "medium", "target_entity": "Prosperity Party", "language": "amharic"},
            "prosperity party": {"severity": "low", "target_entity": "Prosperity Party", "language": "english"},
            "አዴ": {"severity": "low", "target_entity": "ADP", "language": "amharic"},
            "adp": {"severity": "low", "target_entity": "ADP", "language": "english"},
            "በድ አዴፓ": {"severity": "high", "target_entity": "ADP", "language": "amharic"},
            "የአዴፓ አመራሮች ካላለቁ የአማራ ህዝብ": {"severity": "critical", "target_entity": "ADP", "language": "amharic"},
            "ቆሻሻዉ ብአዴን ዋጋ ይከፍልባታል።": {"severity": "high", "target_entity": "ANDM/BRADP", "language": "amharic"},
            "ብአዴን ይውደም": {"severity": "critical", "target_entity": "ANDM/BRADP", "language": "amharic"},
            ...
            "ሁሉም ኦሮ ኦነግ ነው": {"severity": "high", "target_entity": "OLF", "language": "amharic"},
            "ያኔ": {"severity": "high", "target_entity": "TPLF", "language": "amharic"},
            ...
            "ንታ ቡድን": {"severity": "high", "target_entity": "TPLF", "language": "amharic"},
            "ጨካኝ ጁንታ": {"severity": "high", "target_entity": "TPLF", "language": "amharic"},
            "ቄሮ": {"severity": "medium", "target_entity": "Qeerroo", "language": "amharic"},
            "ደርጊ": {"severity": "medium", "target_entity": "Derg", "language": "amharic"},
            "ሸኔ": {"severity": "high", "target_entity": "OLA", "language": "amharic"},
            "አብን": {"severity": "medium", "target_entity": "NAMA", "language": "amharic"},
            "የአማራ ላት አብንና ብሄርተኞች": {"severity": "high", "target_entity": "NAMA", "language": "amharic"},
            "ዳውን ዳውን የሽንላዎች ርቲ አብን": {"severity": "high", "target_entity": "NAMA", "language": "amharic"},
            "አይ ሌባ ነው": {"severity": "high", "target_entity": "Abiy Ahmed", "language": "amharic"},
            ...
            "አምባነን መንግስት": {"severity": "high", "target_entity": "Government", "language": "amharic"},
        ...
        # === Violence, Conflict & Incitement Terms ===
        "violence_incitement": {
            ...
            "ይገሉ": {"severity": "critical", "target_entity": "", "language": "amharic"},
            ...
            "አ": {"severity": "critical", "target_entity": "", "language": "amharic"},
            ...
            "አሳፋሪ እናፋቸው": {"severity": "critical", "target_entity": "", "language": "amharic"},
            "Isaan balleessi": {"severity": "critical", "target_entity": "", "language": "oromo"},
            "ማፋት": {"severity": "critical", "target_entity": "", "language": "amharic"},
            ...
            "ዘር ማፋት": {"severity": "critical", "target_entity": "", "language": "amharic"},
            ...
            "እርም ይወሰድ": {"severity": "high", "target_entity": "", "language": "amharic"},
            "በጀገራ ቁረጥ": {"severity": "critical", "target_entity": "", "language": "amharic"},
            "ሊንጦ ይባ": {"severity": "medium", "target_entity": "", "language": "amharic"},
            "እደፍርሻለሁ": {"severity": "critical", "target_entity": "", "language": "amharic"},
            "መድር": {"severity": "critical", "target_entity": "", "language": "amharic"},
            "አበላሽሻለሁ": {"severity": "critical", "target_entity": "", "language": "amharic"},
            "አሲድ እንዳልደፋብሽ": {"severity": "critical", "target_entity": "", "language": "amharic"},
            "ግላት": {"severity": "critical", "target_entity": "", "language": "amharic"},
        ...
        "dehumanizing": {
            ...
            "ከት": {"severity": "high", "target_entity": "", "language": "amharic"},
            ...
            "Kutichaa / Ilmoo saree": {"severity": "high", "target_entity": "", "language": "oromo"},
            ...
            "የአህያ ል": {"severity": "high", "target_entity": "", "language": "amharic"},
            "አሳማ": {"severity": "high", "target_entity": "", "language": "amharic"},
            ...
            "ነሰ ገዳይ": {"severity": "critical", "target_entity": "", "language": "amharic"},
            "ዳይ": {"severity": "critical", "target_entity": "", "language": "amharic"},
            ...
            "ንቆሮ አስተሳሰብ": {"severity": "medium", "target_entity": "", "language": "amharic"},
            ...
            "ል ራስ": {"severity": "medium", "target_entity": "", "language": "amharic"},
            ...
            "በጣም ባለጌ አስተሳሰ": {"severity": "medium", "target_entity": "", "language": "amharic"},
            ...
            "ጨካ": {"severity": "medium", "target_entity": "", "language": "amharic"},
            "ጨካኝ ሰው": {"severity": "medium", "target_entity": "", "language": "amharic"},
            "ጨኝ አስተሳሰብ": {"severity": "medium", "target_entity": "", "language": "amharic"},
            "ጨካኝ ተንኮለኛ": {"severity": "medium", "target_entity": "", "language": "amharic"},
            "ጨካኝ ተንኮለኛ ባህ": {"severity": "medium", "target_entity": "", "language": "amharic"},
            ...
            "ገጋባ": {"severity": "medium", "target_entity": "", "language": "amharic"},
            ...
            "ልፍተኛ": {"severity": "medium", "target_entity": "", "language": "amharic"},
            ...
            "ክፍት አ": {"severity": "medium", "target_entity": "", "language": "amharic"},
            "ለፍላ": {"severity": "low", "target_entity": "", "language": "amharic"},
            "Hasaa-baay'iftuu / Lallabdii": {"severity": "low", "target_entity": "", "language": "oromo"},
            "ጉረኛ": {"severity": "low", "target_entity": "", "language": "amharic"},
            "ወሬብቻ ጉራብ": {"severity": "medium", "target_entity": "", "language": "amharic"},
            ...
            "ጥቅመ": {"severity": "low", "target_entity": "", "language": "amharic"},
            ...
            "ንጣም": {"severity": "medium", "target_entity": "", "language": "amharic"},
            ...
            "ውሸም": {"severity": "medium", "target_entity": "", "language": "amharic"},
            ...
            "የማትባ": {"severity": "low", "target_entity": "", "language": "amharic"},
            ...
            "ተናዳ": {"severity": "low", "target_entity": "", "language": "amharic"},
            ...
            "ትምክተ": {"severity": "high", "target_entity": "Amhara", "language": "amharic"},
            ...
            "ፍታ": {"severity": "medium", "target_entity": "", "language": "amharic"},
            "ቀጣ አጭበርባ": {"severity": "high", "target_entity": "", "language": "amharic"},
            "የሌባ ዘር": {"severity": "high", "target_entity": "", "language": "amharic"},
            "ቅጥረኛ ተላላ": {"severity": "high", "target_entity": "", "language": "amharic"},
            "ባንዳዎች": {"severity": "high", "target_entity": "", "language": "amharic"},
            "በዘዥ ቡድን": {"severity": "high", "target_entity": "", "language": "amharic"},
            "ከፋይ አካል": {"severity": "medium", "target_entity": "", "language": "amharic"},
            "ሴኛ አካል": {"severity": "medium", "target_entity": "", "language": "amharic"},
            ...
            "ላት": {"severity": "medium", "target_entity": "", "language": "amharic"},
            ...
            "Yakkaamaa / Balleessaa-qabeessa": {"severity": "medium", "target_entity": "", "language": "oromo"},
        ...
        "election_governance": {
            ...
            "የተበበረ": {"severity": "medium", "target_entity": "", "language": "amharic"},
            ...
            "የአርታይድ ሥርዓት": {"severity": "high", "target_entity": "", "language": "amharic"},
            "አፓርታይድ": {"severity": "high", "target_entity": "", "language": "amharic"},
            "ካድሬ qoonqoo": {"severity": "high", "target_entity": "", "language": "oromo"}
        },
        
        # === Foreign Interference, Borders & Xenophobia ===
        "foreign_interference": {
            "ብፅ": {"severity": "low", "target_entity": "Egypt", "language": "amharic"},
            ...
            "ኤርት": {"severity": "low", "target_entity": "Eritrea", "language": "amharic"},
            "eritrea": {"severity": "low", "target_entity": "Eritrea", "language": "english"},
            "አሜካ": {"severity": "low", "target_entity": "USA", "language": "amharic"},
            ...
            "ው": {"severity": "medium", "target_entity": "", "language": "amharic"},
            ...
            "ዳ": {"severity": "medium", "target_entity": "", "language": "amharic"},
            "የባዳ ር": {"severity": "high", "target_entity": "", "language": "amharic"},
            "ባዳ የባ ዘር ነክ እ": {"severity": "high", "target_entity": "", "language": "amharic"},
            "ወፍ ዘሽ": {"severity": "high", "target_entity": "", "language": "amharic"},
        ...
        "religious_cultural": {
            ...
            "ኢስላስት": {"severity": "medium", "target_entity": "Islam", "language": "amharic"},
            "አልሸባ": {"severity": "high", "target_entity": "Al-Shabaab", "language": "amharic"},
            "ቦኮሀም": {"severity": "high", "target_entity": "Boko Haram", "language": "amharic"},
            "ጅሀድ": {"severity": "medium", "target_entity": "Islam", "language": "amharic"},
            "ጅሀዲስት": {"severity": "high", "target_entity": "Islam", "language": "amharic"},
            "ሀብይ": {"severity": "medium", "target_entity": "Wahhabism", "language": "amharic"},
            "አባሽ": {"severity": "medium", "target_entity": "Ahbash", "language": "amharic"},
            "ክርስያን": {"severity": "low", "target_entity": "Christian", "language": "amharic"},
            ...
            "프로테스타ንት": {"severity": "low", "target_entity": "Protestant", "language": "amharic"},
            ...
            "ይሁ ": {"severity": "high", "target_entity": "", "language": "amharic"},
            ...
            "ኦት": {"severity": "medium", "target_entity": "Pagan", "language": "amharic"},
            "ጣት አምላኪ": {"severity": "high", "target_entity": "Pagan", "language": "amharic"},
            ...
            "አስማተኛ ር": {"severity": "high", "target_entity": "", "language": "amharic"},
            ...
            "ሞጣወ ተማ": {"severity": "high", "target_entity": "Muslims", "language": "amharic"},
            "የእርጎ ዝንብ ሆንን ሙስሊሞች አቃጠሉ ያለ የለ።": {"severity": "high", "target_entity": "Muslims", "language": "amharic"},
            "ምድ ኢሬቻም": {"severity": "high", "target_entity": "Oromo/Irreecha", "language": "amharic"},
            "ጽንፈ": {"severity": "medium", "target_entity": "", "language": "amharic"},
            ...
            "የፖለቲካ ሴራ ሀሳብ": {"severity": "medium", "target_entity": "", "language": "amharic"}
        },
        ...
        "gender_misogynistic": {
            ...
            "ገረ": {"severity": "medium", "target_entity": "Women", "language": "amharic"},
            "ገርዳ ": {"severity": "high", "target_entity": "Women", "language": "amharic"},
            ...
            "የተላሽ": {"severity": "medium", "target_entity": "Women", "language": "amharic"},
            "የለቀች": {"severity": "medium", "target_entity": "Women", "language": "amharic"},
            ...
            "የተፈመባት ጥቃት በአለባበሷ ነው": {"severity": "high", "target_entity": "Women", "language": "amharic"},
            ...
            "መጽፍ ቅዱስ እንሚለው ሴት ለባሏ ትገዛ": {"severity": "medium", "target_entity": "Women", "language": "amharic"},
            "የበታች መሆን አለባቸው": {"severity": "high", "target_entity": "Women", "language": "amharic"},
            "ሴቶት ታዛዥ": {"severity": "medium", "target_entity": "Women", "language": "amharic"},
            "ሴቶት አጋዥ ናቸው እንደ መሪ መን የለባቸውም": {"severity": "high", "target_entity": "Women", "language": "amharic"},
            "አባታዊነትና የንድ የበላይነት": {"severity": "medium", "target_entity": "Women", "language": "amharic"},
            "ሴቶች ድመቸውን ከፍ አርገው መናገር የለባቸውም": {"severity": "high", "target_entity": "Women", "language": "amharic"},
            "ት ወደ ወጥሽ": {"severity": "high", "target_entity": "Women", "language": "amharic"},
            ...
            "dhaqna-hin qabannee": {"severity": "high", "target_entity": "Women", "language": "oromo"},
            ...
            "madaqxuu": {"severity": "high", "target_entity": "Women", "language": "oromo"},
            ...
            "እንደሴት አትን ": {"severity": "medium", "target_entity": "Men", "language": "amharic"},
            "ሴት አትሁን": {"severity": "medium", "target_entity": "Men", "language": "amharic"},
            "ወንዳገረ": {"severity": "medium", "target_entity": "Intersex/Women", "language": "amharic"},
            "ወንድ የመሰለች": {"severity": "medium", "target_entity": "Women", "language": "amharic"},
            "ሴት አዉል": {"severity": "medium", "target_entity": "Men", "language": "amharic"},
            "ይሄኔ የሆነ ንድ ነው የለቀብሽ": {"severity": "medium", "target_entity": "Women", "language": "amharic"},
            "ሴት አዳጅ": {"severity": "low", "target_entity": "Men", "language": "amharic"},
            "spinster": {"severity": "low", "target_entity": "Women", "language": "english"},
            "የተች": {"severity": "medium", "target_entity": "Women", "language": "amharic"},
        ...
        "discriminatory_homophobic": {
            ...
            "ግብረ ዶማዊ አመለከት": {"severity": "high", "target_entity": "LGBTQ+", "language": "amharic"},
            ...
            "ሽቲዎች": {"severity": "high", "target_entity": "LGBTQ+", "language": "amharic"}
        },
        ...
        "socio_economic_caste": {
            ...
            "ሪያ": {"severity": "high", "target_entity": "", "language": "amharic"},
            "የባሪያ አመለካከት": {"severity": "high", "target_entity": "", "language": "amharic"},
            "Garee garbaa": {"severity": "high", "target_entity": "", "language": "oromo"},
            "ቂ": {"severity": "high", "target_entity": "Faqi Caste", "language": "amharic"},
            "አቢ": {"severity": "medium", "target_entity": "", "language": "amharic"},
            ...
            "የመንው መሪ": {"severity": "medium", "target_entity": "", "language": "amharic"},
            "ኮተታም": {"severity": "low", "target_entity": "", "language": "amharic"},
            "ደርቡሽ": {"severity": "medium", "target_entity": "", "language": "amharic"},
            "Daakuu-galeessa / Daara-degaa": {"severity": "medium", "target_entity": "", "language": "oromo"},
...
class LexiconsView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if cached_data:
            ...
            # Add lexicon count to cached context
        ...
        results_to_cache = {
            ...
            'start_date': start_date.date().isoformat() if hasattr(start_date, 'date') else start_date,
            'end_date': end_date.date().isoformat() if hasattr(end_date, 'date') else end_date,
            'lexicon_term_count': self._get_lexicon_term_count(),  # Add lexicon count
        }
    ...
    def _run_ai_analysis_background(post_ids, cache_key):
        ...
        try:
            ...
            for idx, post in enumerate(posts):
                if post.original_text and len(post.original_text) > 20:
                    try:
                        ...
                        # Update progress in cache every 10 posts
                        if (idx + 1) % 10 == 0:
                            cache.set("lexicon_analysis_progress", {
                                'current': idx + 1,
                                'total': posts.count(),
                                'percentage': round((idx + 1) / posts.count() * 100, 1)
                            }, 300)
            ...
            # Clear progress
            cache.delete("lexicon_analysis_progress")
