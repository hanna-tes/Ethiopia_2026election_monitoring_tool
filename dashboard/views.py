    ...
    LEXICON_CONFIG = {
        "lexicon": {
            ...
            "ethnic_identity": {
                ...
                "አሳፋሪ ነፍጠኛ": {"severity": "high", "target_entity": "Amhara", "language": "amharic"},
                ...
                "ጋላ ነህ": {"severity": "high", "target_entity": "Oromo", "language": "amharic"},
                "አንተ ጋላ": {"severity": "high", "target_entity": "Oromo", "language": "amharic"},
                "ጥምብ ጋላ": {"severity": "high", "target_entity": "Oromo", "language": "amharic"},
                ...
                "አጋሜ ውያኔ ትግሬ ነው": {"severity": "high", "target_entity": "Tigrayan", "language": "amharic"},
                "ቅማላም ትግሬ": {"severity": "high", "target_entity": "Tigrayan", "language": "amharic"},
                ...
                "አይ ቆምጨ ፋራዉ": {"severity": "high", "target_entity": "Amhara", "language": "amharic"},
            ...
            "political_groups": {
                ...
                "በድኑ አዴፓ": {"severity": "high", "target_entity": "ADP", "language": "amharic"},
                ...
                "ዳውን ዳውን የሽንፍላዎች ፓርቲ አብን": {"severity": "high", "target_entity": "NAMA", "language": "amharic"},
            ...
            "violence_incitement": {
                ...
                "ይገደሉ": {"severity": "critical", "target_entity": "", "language": "amharic"},
                ...
                "አሳፋሪ እናጥፋቸው": {"severity": "critical", "target_entity": "", "language": "amharic"},
                ...
                "አፍርስ": {"severity": "high", "target_entity": "", "language": "amharic"},
            ...
            "dehumanizing": {
                ...
                "ፈረስ": {"severity": "medium", "target_entity": "", "language": "amharic"},
                ...
                "ቅል ራስ": {"severity": "medium", "target_entity": "", "language": "amharic"},
                ...
                "ገብጋባ": {"severity": "medium", "target_entity": "", "language": "amharic"},
                ...
                "ጥጋበኛ": {"severity": "medium", "target_entity": "", "language": "amharic"},
                ...
                "ተለጣፊ": {"severity": "medium", "target_entity": "", "language": "amharic"},
                "ባለጊዜ": {"severity": "medium", "target_entity": "", "language": "amharic"},
                "ቅጥረኛ": {"severity": "medium", "target_entity": "", "language": "amharic"},
                "ጠባብ": {"severity": "medium", "target_entity": "", "language": "amharic"},
                ...
                "ከፋፋይ": {"severity": "medium", "target_entity": "", "language": "amharic"},
                ...
                "ንፍጣም": {"severity": "medium", "target_entity": "", "language": "amharic"},
                ...
                "ቀፋፊ ": {"severity": "medium", "target_entity": "", "language": "amharic"},
                "ታስጠላላችሁ": {"severity": "medium", "target_entity": "", "language": "amharic"},
                ...
                "የማትረባ": {"severity": "low", "target_entity": "", "language": "amharic"},
                ...
                "ብዳታም": {"severity": "high", "target_entity": "", "language": "amharic"},
                ...
                "ቅሌታም": {"severity": "medium", "target_entity": "", "language": "amharic"},
                ...
                "ጠማሞች": {"severity": "medium", "target_entity": "", "language": "amharic"},
                "ጠማማ ": {"severity": "medium", "target_entity": "", "language": "amharic"},
                ...
                "ሽፍታ": {"severity": "medium", "target_entity": "", "language": "amharic"},
                ...
                "በዘባዥ ቡድን": {"severity": "high", "target_entity": "", "language": "amharic"},
                "ከፋፋይ አካል": {"severity": "medium", "target_entity": "", "language": "amharic"},
            ...
            "foreign_interference": {
                ...
                "ባዳ የባዳ ዘር ነክ እሽ": {"severity": "high", "target_entity": "", "language": "amharic"},
                ...
                "ቅኝ ገዥ ሀገር": {"severity": "high", "target_entity": "", "language": "amharic"},
            ...
            "religious_cultural": {
                ...
                "ቦኮሀራም": {"severity": "high", "target_entity": "Boko Haram", "language": "amharic"},
                "ጅሀድ": {"severity": "medium", "target_entity": "Islam", "language": "amharic"},
                "ጅሀዲስት": {"severity": "high", "target_entity": "Islam", "language": "amharic"},
                "ወሀብይ": {"severity": "medium", "target_entity": "Wahhabism", "language": "amharic"},
                ...
                "ጣዖት አምላኪ": {"severity": "high", "target_entity": "Pagan", "language": "amharic"},
                ...
                "አስማተኛ ዘር": {"severity": "high", "target_entity": "", "language": "amharic"},
                ...
                "ከሞጣወቺ ተማ": {"severity": "high", "target_entity": "Muslims", "language": "amharic"},
                "የእርጎ ዝንብ ሆንን ሙስሊሞች አቃጠሉ ያለ የለ።": {"severity": "high", "target_entity": "Muslims", "language": "amharic"},
                "ምድረ ኢሬቻም": {"severity": "high", "target_entity": "Oromo/Irreecha", "language": "amharic"},
            ...
            "gender_misogynistic": {
                ...
                "ገርዳሜ ": {"severity": "high", "target_entity": "Women", "language": "amharic"},
                ...
                "አተራማሽ": {"severity": "medium", "target_entity": "Women", "language": "amharic"},
                ...
                "የተፈፀመባት ጥቃት በአለባበሷ ነው": {"severity": "high", "target_entity": "Women", "language": "amharic"},
                ...
                "መጽሃፍ ቅዱስ እንደሚለው ሴት ለባሏ ትገዛ": {"severity": "medium", "target_entity": "Women", "language": "amharic"},
                ...
                "ሴቶት አጋዥ ናቸው እንደ መሪ መሆን የለባቸውም": {"severity": "high", "target_entity": "Women", "language": "amharic"},
                "አባታዊነትና የወንድ የበላይነት": {"severity": "medium", "target_entity": "Women", "language": "amharic"},
                "ሴቶች ድመጻቸውን ከፍ አርገው መናገር የለባቸውም": {"severity": "high", "target_entity": "Women", "language": "amharic"},
                "ሴት ወደ ወጥሽ": {"severity": "high", "target_entity": "Women", "language": "amharic"},
                ...
                "ይሄኔ የሆነ ወንድ ነው የለቀቀብሽ": {"severity": "medium", "target_entity": "Women", "language": "amharic"},
                "ሴት አሳዳጅ": {"severity": "low", "target_entity": "Men", "language": "amharic"},
                "spinster": {"severity": "low", "target_entity": "Women", "language": "english"},
                "የሞተች": {"severity": "medium", "target_entity": "Women", "language": "amharic"},
                "ራቁት ሴቶች": {"severity": "medium", "target_entity": "Women", "language": "amharic"},
                "በቅርቡ ዋጋሽን ታገኛለሽ": {"severity": "high", "target_entity": "Women", "language": "amharic"}
            },
            ...
            "socio_economic_caste": {
                ...
                "አጣቢ": {"severity": "medium", "target_entity": "", "language": "amharic"},
                ...
                "የመንጋው መሪ": {"severity": "medium", "target_entity": "", "language": "amharic"},
